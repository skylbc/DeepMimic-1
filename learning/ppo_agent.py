...
class PPOAgent(PGAgent):
    ...
    def _load_params(self, json_data):
        ...
        self.actor_stepsize_decay = 0.5 if (self.ACTOR_STEPSIZE_DECAY not in json_data) else json_data[
    ...
    def _build_solvers(self, json_data):
        ...
        self._actor_stepsize_tf = tf.get_variable(dtype=tf.float32, name='actor_stepsize', initializer=actor_stepsize,
                                                  trainable=False)
